...
help() {
    ...
    echo
    echo -e "Log in to a running docker container given the container ID and run the command provided as an option. NOTE: The default command is /bin/sh if no [-c] command is provided; /bin/sh has less functionality than /bin/bash or /bin/ash (Alpine images)." | fmt
    echo
    ...
    echo -e "\t-i\t Runing image container ID (can be found running 'docker ps')" | fmt
